...
MIDDLEWARE = [
    'whitenoise.middleware.WhiteNoiseMiddleware',  # Add this at the top of the middleware stack
...
DATABASES = {
    'default': env.db(),  # This will automatically read DATABASE_URL from .env
}
